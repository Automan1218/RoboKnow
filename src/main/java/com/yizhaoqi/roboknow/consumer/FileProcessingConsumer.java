package com.yizhaoqi.roboknow.consumer;

import com.yizhaoqi.roboknow.config.KafkaConfig;
import com.yizhaoqi.roboknow.model.FileProcessingTask;
import com.yizhaoqi.roboknow.service.ParseService;
import com.yizhaoqi.roboknow.service.VectorizationService;
    ...
    private InputStream downloadFileFromStorage(String filePath) throws ServerException, InsufficientDataException, ErrorResponseException, IOException, NoSuchAlgorithmException, InvalidKeyException, InvalidResponseException, XmlParserException, InternalException {
        ...
        try {
            ...
            if (filePath.startsWith("http://") || filePath.startsWith("https://")) {
                ...
                // 添加必要的请求头
                connection.setRequestProperty("User-Agent", "RoboKnow-FileProcessor/1.0");
