...
The first challenge was deciding how to divide the project into clear phases. RoboKnow includes many different technologies, so it was easy for the scope to become too large too early. Authentication, file upload, parsing, retrieval, AI chat, and organization permission logic are all connected, but implementing everything at once would make the project difficult to control.
